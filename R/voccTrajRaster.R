...
#'
#' @usage voccTrajRaster(lonlat, vel, ang, mn, tyr, trajID = 1:nrow(lonlat), correct = FALSE)
#'
...
voccTrajRaster <- function(lonlat, vel, ang, mn, tyr, trajID = 1:nrow(lonlat), correct = FALSE){
